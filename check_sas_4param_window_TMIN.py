...
def process_station_sas_4p_window(file_path, output_dir):
    ...
    try:
        ...
        pivot_df = df_ref.pivot(index='year', columns='MONTH_DAY', values='TMIN')
...
def main():
    ...
    data_dir = 'Data'
    output_dir = 'SAS_4Param_Window_Results_TMIN'
    ...
    summary_df.to_csv('sas4_window_TMIN.csv', index=False)
